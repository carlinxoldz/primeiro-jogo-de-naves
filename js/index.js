function start() {
  ...
  //Começo da função de movejogador
  ...
  //Começo da função de mover inimigo1
  ...
  //Começo da função de mover inimigo 2
  ...
  //Começo da função de mover amigo
  function moveamigo() {
